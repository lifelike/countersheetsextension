...
doc/counters_size_list.png: svgtests/bitmaps/counters_size_list.csv-template-counters.svgr_0_f_90_O_0.svgcs_layer_0001.png
	cp -v $^ $@

doc/markers_list.png: svgtests/bitmaps/markers_list.csv-template-counters.svgr_0_f_90_O_0.svgcs_layer_0001.png
	cp -v $^ $@

doc/standees_20x20.png: svgtests/bitmaps/standees.csv-standees.svgR_true_O_0.svgcs_layer_0001.png
	cp -v $^ $@

doc/standees_20x35.png: svgtests/bitmaps/standees.csv-standees.svgR_true_O_0.svgcs_layer_0002.png
	cp -v $^ $@
